            ...
            <div className="col-md-8 my-5">
              <div className="containerS">
                ...
                <p className="card-text title ">
                  สวัสดีครับ ผมชื่อ ภีม ผมเรียนจบป.ตรี สาขาวัสดุศาสตร์
                  (Materials Science) แล้วได้ทำงานเกี่ยวกับการควบคุมการผลิต
                ...
                <p className="card-text title">
                  ดังนั้นผมจึงเริ่มศึกษาการเขียนโค้ด HTML ให้แสดงผลหน้าเว็บ “
                  Hello World” ในตอนนั้นผมรู้สึกสนุกกับมันมาก
                  ทำให้มีความสนใจมากขึ้น จึงได้ศึกษาเรียนรู้และทำเป็นงานอดิเรก
                  จนทำให้ผมเกิดความมั่นใจ
                  จึงตัดสินใจออกจากงานมาศึกษาเรียนรู้เกี่ยวกับการพัฒนาเว็บไซต์อย่างจริงจัง
                  จากคอร์สเรียนต่างๆ ในหลายๆที่เช่น Borntodev, Kong Ruksiam,
                  Udemy เป็นต้น
                </p>
