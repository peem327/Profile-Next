          ...
          <div className="col-md-8 my-5">
            <div className="containerS">
              ...
              <p className="card-text title ">
                ...
                และมันเป็นความฝันในวัยเด็กที่อยากเขียนทำเว็บ และโปรแกรม
                แต่ผมได้ตัดโอกาสของตัวเองไป
                เพราะคิดว่าตนเองคงทำไม่ได้เพราะไม่เก่งภาษาอังกฤษ
                แต่ที่มาเรียนรู้เรื่องนี้อีกครั้งเพราะผมอยากทำในสิ่งที่ผมรักครับ
              </p>

              <p className="card-text title">
                ก่อนหน้านี้ผมได้เริ่มศึกษาการเขียนโค้ด HTML ให้แสดงผลหน้าเว็บ “ Hello
                World” ในตอนนั้นผมสนุกกับมันมาก และได้ศึกษาเรียนรู้มาเรื่อย ๆ
                แต่ก็ไม่จริงจังเท่าไหร่เพราะไม่มีเวลาให้กับมันมากนัก
                ผมจึงตัดสินใจออกจากงานมาศึกษาเรียนรู้เกี่ยวกับการพัฒนาเว็บไซต์
