                ...
                <div className="row">
                    ...
                    <div className="col-md-8 my-5">
                        <div className="containerS">
                            ...
                            แต่ที่มาเรียนรู้เรื่องนี้อีกครั้งเพราะผมอยากทำในสิ่งที่ผมรักครับ  </p>

                            <p className="card-text  title">
                                ก่อนหน้าที่จะออกจากงานประมาณ 4 เดือน ผมได้เริ่มศึกษาการเขียนโค้ด HTML ให้แสดงผลหน้าเว็บ “ Hello World” ผมได้หลงรักมัน และได้ศึกษาเรียนรู้มาเรื่อย ๆ แต่ก็ไม่จริงจังเท่าไหร่เพราะไม่มีเวลาให้กับมันมากนัก แต่เมื่อผมได้ออกจากงานเก่า  ผมคิดที่จะเปลี่ยนสายงาน จึงได้เรียนรู้ด้วยตัวเองทั้งจากคอร์สเรียนฟรีและมีค่าใช้จ่ายจาก 
                        ...
                        <div className="container mb-4">
                            <div className="row mt-3">
                                ...
                                <div className="col-md mb-3">
                                    ...
                                    <div className="progress">
                                        < div className="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" id="language-one"></div>
                                    </div>
                                </div>
                                ...
                                <div className="col-md ">
                                    <span> <h6>CSS</h6></span>
                                    <div className="progress">
                                        <div className="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" id="language-two"></div>
                                    </div>
                                </div>
                            </div>
                            <br />
                            <div className="row">
                                ...
                                <div className="col-md mb-3">
                                    <span> <h6>JS</h6></span>
                                    <div className="progress">
                                        <div className="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" id="language-three"></div>
                                    </div>
                                </div>
                ...
                <div className="container wheat">
                    <div className="row">
                        <div className=" ">
                            ...
                            <h3 className="section-subheading whitesmoke mb-5">When we work together.</h3>
                        </div>
                    </div>
                    <div className="row mt-5  text-center">
                        <div className="col-md-4">
                            ...
                            <p className="whitesmoke">ถ้าผมได้ทำอะไร ผมจะทำให้ถึงที่สุดและทำทุกวิธี เพื่อให้งานออกมาดีที่สุด</p>
                        </div>
                        <div className="col-md-4">
                            <span className="fa-stack fa-4x">
                        ...
                        <div className="col-md-4">
                            ...
                            <p className="whitesmoke">ถ้าเราได้ร่วมงานกัน จะไม่ทำให้คุณผิดหวังครับ</p>
                        </div>
                    </div>
                </div >
            </div>
